...
.Ibat
xref:ibat:ROOT:index.adoc[image:ibat/main.jpg[width=200]]

=== Health

.Eye2brain
xref:eye2brain:ROOT:index.adoc[image:eye2brain/main.jpg[width=200,label=Eye2brain]]

.HemoTum++
xref:hemotumpp:ROOT:index.adoc[image:hemotumpp/main.png[width=200]]

.Micro Swimmers
xref:swimmer:ROOT:index.adoc[image:swimmer/main.png[width=200]]

=== Physics

.High Field Magnets
xref:hifimagnet:ROOT:index.adoc[image:hifimagnet/main.jpg[width=200]]
